# Image Sync Status & Generation Plan
...
| Items needing images | 38 |
| Skippable items | 33 |
| **Total menu items** | **113** |

### Items WITH Images (42 dishes mapped)
These have matching images in `/data/gallery_optimized/`:

| Menu Item | Image Source |
|-----------|--------------|
| Boneless Spare Ribs | appetizers--bbq-spare-ribs |
| Chicken Dumplings (6) | appetizers--pan-fried-dumplings |
| Edamame | appetizers--edamame |
| Egg Roll (1) | appetizers--egg-rolls |
| Lettuce Wraps | appetizers--chicken-lettuce-wraps |
| Pork Dumplings (6) | appetizers--pan-fried-dumplings |
| General Tsao's Chicken | chicken--general-tsos-chicken |
| Happy Family | specialties--happy-family |
| Pepper Steak | beef--pepper-steak |
| Shrimp w/ Lobster Sauce | shrimp--shrimp-with-broccoli |
| Twice Cooked Pork | pork--twice-cooked-pork |
| BBQ Pork Fried Rice | fried-rice--pork-fried-rice-combo |
| Combination Fried Rice | fried-rice--house-special-fried-rice |
| Shrimp Fried Rice | fried-rice--shrimp-fried-rice |
| Grilled Tilapia | shrimp--grilled-tilapia |
| Chow Fun Flat Rice Noodles | noodles--beef-chow-fun |
| Lo Mein Noodles | noodles--beef-lo-mein |
| Phad Thai Noodles | noodles--pad-thai |
| Singapore Rice Noodles | noodles--singapore-noodles |
| Egg Drop Soup | soups--egg-drop-soup |
| Hot & Sour Soup | soups--hot-and-sour-soup |
| Wonton Soup | soups--wonton-soup |
| Crispy Tilapia | shrimp--grilled-tilapia |
| Ginger Shrimp | shrimp--garlic-shrimp-snow-peas |
| Mandarin Pecan | chicken--honey-pecan-chicken |
| Vanilla Shrimp | shrimp--honey-walnut-shrimp |
| Broccoli Stir-Fry | chicken--chicken-with-broccoli-takeout |
| Hunan Stir-Fry | chicken--hunan-chicken-lunch |
| Kung Pao Stir-Fry | chicken--kung-pao-chicken |
...
- **Catering Options (8)**: Can use category banners
- **Lunch Specials (10)**: Share images with regular menu items
- **Side Orders (7)**: Simple items like rice, noodles

---

## Items Needing Images (38 dishes)

### Priority 1: Appetizers (5)
| Item | Prompt |
|------|--------|
...
| Broccoli Stir-Fry (Veg) | Fresh broccoli florets stir-fried in garlic sauce |
...
## Generation Plan with Nano Banana

### Step 1: Create prompts file
Create `/data/nano-banana-batch-kit/prompts/missing_dishes.json` with all 38 prompts

### Step 2: Run batch generation
```bash
cd /data/nano-banana-batch-kit
export GEMINI_API_KEY="your-key"
export OUTPUT_DIR="../gallery_generated"
node scripts/batch-generate-missing.mjs
```

### Step 3: Optimize generated images
Run through the same optimization pipeline as existing images

### Step 4: Upload to Sanity
Use the image upload script to sync all images to Sanity
...
- **Angle**: Overhead (top-down) or 45-degree
- **Lighting**: Natural, soft lighting
- **Background**: Dark wooden table
- **Props**: Chopsticks, small sauce dishes, garnishes
- **Plate style**: White ceramic or traditional Chinese plates
- **Resolution**: 1024x1024 minimum
- **Format**: Generate both hero (4:3) and square (1:1) versions
