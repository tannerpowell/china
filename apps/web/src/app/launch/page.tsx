...
const groups: Group[] = [
  {
    ...
    items: [
      ...
      { text: "Restaurant JSON-LD: address, geo, hours, cuisines, price range", status: "live" },
      ...
      { text: "Owner CMS at /studio (menu, prices, descriptions, tags)", note: "Needs the two Sanity dashboard steps below before login works.", status: "live" },
